    ...
    <div class="wr-container wr-card">
      ...
      <div class="wr-carousel wr-reels-carousel" data-i18n-attr="aria-label:retreat_wadi_reels_label" aria-label="Wadi Rum retreat reels">
        <div class="wr-carousel__track" id="wadi-reels-track">
          <figure class="wr-carousel__item wr-carousel__item--reel"><div class="wr-reel-card"><video class="wr-reel-video" src="/media/wadi-rum/reel-05.mp4" poster="/media/wadi-rum/gallery-11.jpg" muted playsinline loop preload="metadata" data-i18n-attr="aria-label:retreat_wadi_reel_aria_5"></video><button type="button" class="wr-reel-playbtn" data-i18n-attr="aria-label:retreat_wadi_reel_play"><svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M8 5v14l11-7z"/></svg></button></div></figure>
          <figure class="wr-carousel__item wr-carousel__item--reel"><div class="wr-reel-card"><video class="wr-reel-video" src="/media/wadi-rum/reel-06.mp4" poster="/media/wadi-rum/gallery-12.jpg" muted playsinline loop preload="metadata" data-i18n-attr="aria-label:retreat_wadi_reel_aria_6"></video><button type="button" class="wr-reel-playbtn" data-i18n-attr="aria-label:retreat_wadi_reel_play"><svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M8 5v14l11-7z"/></svg></button></div></figure>
          <figure class="wr-carousel__item wr-carousel__item--reel"><div class="wr-reel-card"><video class="wr-reel-video" src="/media/wadi-rum/reel-01.mp4" poster="/media/wadi-rum/gallery-01.jpg" muted playsinline loop preload="metadata" data-i18n-attr="aria-label:retreat_wadi_reel_aria_1"></video><button type="button" class="wr-reel-playbtn" data-i18n-attr="aria-label:retreat_wadi_reel_play"><svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M8 5v14l11-7z"/></svg></button></div></figure>
          <figure class="wr-carousel__item wr-carousel__item--reel"><div class="wr-reel-card"><video class="wr-reel-video" src="/media/wadi-rum/reel-02.mp4" poster="/media/wadi-rum/gallery-02.jpg" muted playsinline loop preload="metadata" data-i18n-attr="aria-label:retreat_wadi_reel_aria_2"></video><button type="button" class="wr-reel-playbtn" data-i18n-attr="aria-label:retreat_wadi_reel_play"><svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M8 5v14l11-7z"/></svg></button></div></figure>
          <figure class="wr-carousel__item wr-carousel__item--reel"><div class="wr-reel-card"><video class="wr-reel-video" src="/media/wadi-rum/reel-03.mp4" poster="/media/wadi-rum/gallery-03.jpg" muted playsinline loop preload="metadata" data-i18n-attr="aria-label:retreat_wadi_reel_aria_3"></video><button type="button" class="wr-reel-playbtn" data-i18n-attr="aria-label:retreat_wadi_reel_play"><svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M8 5v14l11-7z"/></svg></button></div></figure>
          <figure class="wr-carousel__item wr-carousel__item--reel"><div class="wr-reel-card"><video class="wr-reel-video" src="/media/wadi-rum/reel-04.mp4" poster="/media/wadi-rum/gallery-04.jpg" muted playsinline loop preload="metadata" data-i18n-attr="aria-label:retreat_wadi_reel_aria_4"></video><button type="button" class="wr-reel-playbtn" data-i18n-attr="aria-label:retreat_wadi_reel_play"><svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M8 5v14l11-7z"/></svg></button></div></figure>
        </div>
        <div class="wr-carousel__controls">
