...
(function () {
  ...
  var translations = {
    en: {
      ...
      events_ib_cancel_2: 'If cancellation occurs up to 15 days before the event, the amount paid can be transferred to a future retreat or event.',
      events_ib_cancel_3: 'If cancellation occurs less than 15 days before the event, no refund is possible due to prior commitments with the venue and service providers.',
...
This retreat is not only a trip to a beautiful place; it is a real invitation to return to yourself: to your body, to your breath, and to the inner sea that calms when it finds the right space. Zanzibar here is not just a destination—it is a complete experience guided carefully by Nawal, with a deep feminine touch that makes each participant feel part of something living, soft, and transformative.`,
    ...
    ar: {
      ...
      events_ib_cancel_2: 'في حال الإلغاء حتى 15 يوماً قبل موعد الفعالية يمكن تحويل المبلغ المدفوع لخلوة أو فعالية مستقبلية.',
      events_ib_cancel_3: 'في حال الإلغاء قبل أقل من 15 يوماً لا يمكن استرجاع المبلغ بسبب الالتزامات المسبقة مع المكان ومزودي الخدمات.',
