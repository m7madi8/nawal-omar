...
(function () {
  ...
  var translations = {
    en: {
      ...
      retreat_wadi_page_intro: 'A journey into the depth of the soul, where the desert meets the sky. 3.4 - 7.4',
      retreat_wadi_page_intro2: 'This is not just travel. This is an inner transition in a safe feminine space.',
      ...
      retreat_wadi_about_tasneem_name: 'Tasneem Masad',
      retreat_wadi_about_tasneem_role: 'Nurse and Master in NLP',
      retreat_wadi_about_tasneem_text: 'I combine warm containment with professional guidance. Through NLP tools, I offer space and stillness to rebuild your scattered parts and rediscover yourself. I believe true change begins by reorganizing the inner world, and I walk with you toward your most balanced and elevated version.',
      ...
      retreat_wadi_day2_b2: 'Breathwork, healthy breakfast, and deep workshop with Israa.',
      ...
      retreat_wadi_day4_b2: 'Second workshop with Israa and personal rest time.',
      ...
      retreat_wadi_stay1_price: '3500 ILS per person (double room)',
      ...
      retreat_wadi_stay2_price: '3100 ILS per person (double room)',
      retreat_wadi_includes_title: 'Price includes',
      retreat_wadi_inc1: '4 nights accommodation.',
      ...
      retreat_wadi_inc6: '2 workshops with Israa + sound healing + emotional support + professional photography.',
      ...
      retreat_wadi_policy_2: 'Remaining amount is due by 20.3.',
      ...
      retreat_wadi_price_value: '3100 ILS',
...
This retreat is not only a trip to a beautiful place; it is a real invitation to return to yourself: to your body, to your breath, and to the inner sea that calms when it finds the right space. Zanzibar here is not just a destination—it is a complete experience guided carefully by Nawal, with a deep feminine touch that makes each participant feel part of something living, soft, and transformative.`,
    ...
    ar: {
      ...
      retreat_wadi_page_intro: 'رحلة إلى عمق الروح حيث تلتقي الصحراء بالسما. 3.4 - 7.4',
      retreat_wadi_page_intro2: 'هذا ليس مجرد سفر. هذا انتقال داخلي في مساحة أنثوية آمنة.',
      ...
      retreat_wadi_about_tasneem_name: 'تسنيم مساد',
      retreat_wadi_about_tasneem_role: 'ممرضة وماستر في البرمجة اللغوية العصبية',
      retreat_wadi_about_tasneem_text: 'أجمع بين الاحتواء الدافئ والتوجيه المهني. عن طريق أدوات البرمجة اللغوية العصبية أمنحك المساحة والسكينة لترميم شتاتك وإعادة اكتشاف ذاتك من جديد. أؤمن بأن التغيير الحقيقي يبدأ من ترتيب الداخل، وأرافقك للعبور نحو نسختك الأكثر توازنًا ورقيًا.',
      ...
      retreat_wadi_day2_b2: 'تمارين تنفّس + إفطار صحي + ورشة عميقة مع إسراء.',
      ...
      retreat_wadi_day4_b2: 'ورشة ثانية مع إسراء + وقت شخصي للراحة.',
      ...
      retreat_wadi_stay1_price: '3500 شيكل للشخص (غرفة زوجية)',
      ...
      retreat_wadi_stay2_price: '3100 شيكل للشخص (غرفة زوجية)',
      retreat_wadi_includes_title: 'يشمل السعر',
      retreat_wadi_inc1: '4 ليالي إقامة.',
      ...
      retreat_wadi_inc6: 'ورشتيّن مع إسراء + ساوند هيلينغ + مرافقة نفسية + تصوير احترافي.',
      ...
      retreat_wadi_policy_2: 'المبلغ المتبقي يُدفع حتى موعد أقصاه 20.3.',
      ...
      retreat_wadi_price_value: '3100 شيكل',
