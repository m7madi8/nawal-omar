...
(function () {
  ...
  var translations = {
    en: {
      ...
      retreat_dahab_cv_price: '3200₪',
      retreat_dahab_cv_price_old: '3400₪',
      ...
      retreat_dahab_cv_proof_label: 'From our last retreat — 2025',
      retreat_dahab_cv_t1_name: 'Ayeh',
      retreat_dahab_cv_t1_country: 'Haifa',
      retreat_dahab_cv_t1_quote: 'This retreat completely changed how I see myself.',
      retreat_dahab_cv_t2_name: 'Hanan',
      retreat_dahab_cv_t2_country: 'Nazareth',
      retreat_dahab_cv_t2_quote: 'I returned home lighter, clearer, and more connected to my body.',
      retreat_dahab_cv_t3_name: 'Fairuz',
      retreat_dahab_cv_t3_country: 'Jaffa',
      retreat_dahab_cv_t3_quote: 'The safest space I have ever experienced with women.',
      ...
      retreat_dahab_cv_final_price: '3200₪',
      ...
      retreat_dahab_why_dahab_p1: 'There is something here that is hard to put into words.',
      retreat_dahab_why_dahab_p2: 'The sea, the mountains, the simplicity, the people, and the calm energy all create an ideal environment for healing, reflection, and renewal.',
      ...
      retreat_dahab_cancel_title: 'Cancellation policy',
      ...
      retreat_dahab26_price_early: 'First 10 participants: 3200₪',
      retreat_dahab26_price_regular: 'After that: 3400₪',
...
This retreat is not only a trip to a beautiful place; it is a real invitation to return to yourself: to your body, to your breath, and to the inner sea that calms when it finds the right space. Zanzibar here is not just a destination—it is a complete experience guided carefully by Nawal, with a deep feminine touch that makes each participant feel part of something living, soft, and transformative.`,
    ...
    ar: {
      ...
      retreat_dahab_cv_proof_label: 'من آخر خلوة — ٢٠٢٥',
      retreat_dahab_cv_t1_name: 'ايه',
      retreat_dahab_cv_t1_country: 'حيفا',
      retreat_dahab_cv_t1_quote: 'غيّرت هاي الخلوة طريقة تفكيري كلياً.',
      retreat_dahab_cv_t2_name: 'حنان',
      retreat_dahab_cv_t2_country: 'الناصرة',
      retreat_dahab_cv_t2_quote: 'رجعت أخف، أوضح، وأكثر اتصالاً بجسدي.',
      retreat_dahab_cv_t3_name: 'فيروز',
      retreat_dahab_cv_t3_country: 'يافا',
      retreat_dahab_cv_t3_quote: 'أكثر مساحة آمنة عشتها مع نساء.',
      ...
      retreat_dahab_cancel_title: 'سياسة الإلغاء',
      ...
      retreat_dahab26_price_early: 'أول 10 مشتركات: 3200 شيكل',
      retreat_dahab26_price_regular: 'بعدها: 3400 شيكل',
